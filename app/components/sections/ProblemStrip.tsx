...
/**
 * ProblemStrip section — a single-line thesis ("writing once, reformatting
 * five times, is not a system") followed by a row of the platforms Remix
 * targets. On entering the viewport, the line settles first, then each
          ...
          {PLATFORM_ICONS.map((icon) => (
            ...
            >
              <svg
                ...
                role="img"
                className="h-5 w-5 text-foreground/50 sm:h-6 sm:w-6"
              >
                {icon.path}
              </svg>
            </motion.li>
